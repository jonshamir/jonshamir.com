...
In this post I will explore how to implement a smooth transition between light and dark mode, and how modern CSS `@property` declarations can make this easy! You can see the effect by clicking the small icon in the top-right corner, or in this small demo sandbox:
