...
For this website, I wanted to have a nice animation when switching between light and dark modes. You can check out the final result by clicking the small icon in the top-left corner - colors should quickly cross-fade, while the button itself does a little spherical animation.
