...
Transitioning a user inteface from dark to light mode can be pretty jarring - you can't prevent a user from accidentally being blinded in the middle of the night but you can give the eyes a bit of time to adjust by animating the transition. To me at least it feels more gentle.
