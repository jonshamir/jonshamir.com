...
The text color and background cross-fade nicely, but our button still flashes immediately to the new color. We can try adding a transition to the button properties as well
