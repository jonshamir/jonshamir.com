...
On [caniuse.com](https://caniuse.com/?search=%40property) you can see that the vast majority of browsers support `@property` declarations (~94% at the time of writing).
