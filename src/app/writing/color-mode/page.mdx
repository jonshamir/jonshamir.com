...
In addition to our original variable definitions, we can tell the browser the _type_ of the variables by using `@property` blocks with `syntax: "<color>"`. By typing the custom property as a color, the browser can interpolate between values instead of swapping them instantly.
