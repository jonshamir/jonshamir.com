...
For my website, I wanted to have a nice animation when switching between light and dark modes. You can check out the final result here:

<ColorModeToggleDemo showToggle isAnimated>
  Click the button to toggle modes:
</ColorModeToggleDemo>

You can also see the effect by clicking the small icon in the top-left corner (Unless I redesigned this site...) Colors should quickly cross-fade, while the button itself does a little spherical animation.
...
First thing's first - how to name this feature?
...
I found 3 commonly used terms - **Color Theme**, **Color Scheme** and **Color Mode**, as well as some less common options such as _Brightness_ in Flutter or _UIUserInterfaceStyle_ (I'm looking at you, UIKit). I'll focus on the 3 prevalent options:
