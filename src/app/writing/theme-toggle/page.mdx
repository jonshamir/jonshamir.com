...
To get a nice animation between the color modes, we need to declare a transition for any property using the variables. For consistency across a website, I like to define a `--transition-defaults` variable which I can reuse:
